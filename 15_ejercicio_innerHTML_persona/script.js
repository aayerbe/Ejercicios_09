let personas = {
    ...
    "about": "Dolor incididunt adipisicing elit cupidatat aliquip ea incididunt ",
...
if(nombre==personas["Bridgette McGuire"]["name"] || nombre==personas["Melinda Wheele"]["name"] || 
nombre==personas["Ward Fulton"]["name"] ||nombre==personas["Tessa Sellers"]["name"] ||
nombre==personas["Kimberley Roberson"]["name"] || nombre==personas["Eleanor Stafford"]["name"] ||
nombre==personas["Crane Harris"]["name"]){
    
    body.innerHTML=`<div class="container">
                        <img src=${personas[nombre]["picture"]}>
                        <h1>${personas[nombre]["name"]}</h1>
                        <p>${personas[nombre]["age"]}</p>
                        <p>${personas[nombre]["email"]}</p>
                        <p>${personas[nombre]["address"]}</p>
                        </div>`
    let clase=document.querySelector(".container")
    body.style.backgroundColor=personas[nombre]["eyeColor"]
    clase.style.height="100vh"
    clase.style.display="flex"
    clase.style.flexDirection="column"
    clase.style.justifyContent="center"
    clase.style.alignItems="center"
}
else{
