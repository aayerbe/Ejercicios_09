...
let fechaDeNacimiento=prompt("Introduce la fecha de nacimiento")
let nombre=prompt("Introduce el nombre")
let apellido=prompt("Introduce el apellido")

console.log("El superheroe es: " + letraNombre[nombre[0]]["masculino"] + " " 
+ letraApellido[apellido[apellido.length-1]]["masculino"] + " " 
+ fechaNacimiento[fechaDeNacimiento[fechaDeNacimiento.length-1]]["masculino"])